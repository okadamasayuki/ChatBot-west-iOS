    ...
    func path(in rect: CGRect) -> Path {
        ...
        if isMine {
            ...
            p.addQuadCurve(to: CGPoint(x: rect.minX, y: rect.minY + drop),
                           control: CGPoint(x: rect.minX - 1, y: rect.minY + 4))
